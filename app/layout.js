    ...
    <html lang="en">
      ...
      */}
      ...
      <body className={`${montserrat.className} mx-32 my-12`}>
        <div >
      {/* <Link href="#"
      className="text-sm bg-gray-600 
      inline-block my-2 py-2 px-4 
      rounded"
      >Home</Link>
      <Link href="#"
      className="text-sm bg-gray-600 
...
<nav class="flex items-center justify-between flex-wrap bg-gray-900 p-6">
  ...
  <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
    <div class="text-sm lg:flex-grow">
      ...
      <Link href="/#" class="block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white">
      About
      </Link>
    </div>
    <div>
      <a href="/#" class="inline-block text-sm px-4 py-2 leading-none border rounded text-white border-white hover:border-transparent hover:text-teal-500 hover:bg-white mt-4 lg:mt-0">Download</a>
        ...
        <div className="py-8">
        <footer class="p-4 bg-black sm:p-6 dark:bg-gray-50" className='my-800'>
